...
filepath = r"c:\Users\3D_OCT\Documents\Antigravity\Presbycor\Chapter_5_Complete.md"
...
for i, line in enumerate(lines):
    if line.startswith("## Referências Bibliográficas"):
        ref_start = i
    if line.startswith("## 5.9. Validação Matemática Independente"):
        val_start = i

if ref_start != -1 and val_start != -1 and val_start > ref_start:
    print(f"Encontrado: Referências na linha {ref_start+1}, Validação na linha {val_start+1}. Corrigindo...")
    ...
    # Remonta o arquivo: Main -> Validação -> --- -> Referências
    new_lines = part_main + ["\n"] + part_val + ["\n\n"] + part_ref
